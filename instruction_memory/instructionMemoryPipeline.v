module instructionMemoryPipeline (
   input [31:0] address,
   ...
   initial begin
      ...
      instructionMemoryRegisters[9] <= 32'b1111111_00000_00000_000_10111_1100011; // beq x0, x0, start # volta pro inicio
   end

   assign instruction = instructionMemoryRegisters[address];
